  ...
  const [expanded, setExpanded] = useState(true)
    ...
    return(
        <aside className=" w-44 ">
          <nav className={`   flex flex-col rounded bg-black border-r shadow-sm  transition-all delay-150 duration-300 ${expanded?"w-54":"w-20"} `}>

          <div className="p-4 pb-2 flex justify-between items-center">
            <p className={`text-white font-inter text-2xl font-medium overflow-hidden transition-all ${expanded?"w-32":"w-0"}`}>taskAid</p>
          ...
          <div className="border-t flex p-3">
            <img className="w-10 h-10 rounded-md" src="./src/assets/profileicon.png"></img>
